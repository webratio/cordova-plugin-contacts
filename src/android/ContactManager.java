...
public class ContactManager extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        /**
         * Check to see if we are on an Android 1.X device. If we are return an error as we do not support this as of Cordova 1.0.
         */
        ...
        /**
         * Only create the contactAccessor after we check the Android version or the program will crash older phones.
         */
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        if (requestCode == CONTACT_PICKER_RESULT) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Cursor c = this.cordova
                        .getActivity()
                        .getContentResolver()
                        .query(RawContacts.CONTENT_URI, new String[] { RawContacts._ID }, RawContacts.CONTACT_ID + " = " + contactId,
                                null, null);
                if (!c.moveToFirst()) {
